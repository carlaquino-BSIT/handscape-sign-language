...
const previousWord =
currentIndex > 0 ? words[currentIndex - 1] : null;
    ...
    <div className="flex min-h-0 flex-col overflow-y-auto">
      ...
      <div className="border-b border-neutral-200 p-6 sm:p-8 lg:p-10">
        <p className="font-mono text-[8px] uppercase tracking-[0.18em] text-blue-600 sm:text-[9px]">
          Filipino Sign Language / Common Word
        </p>

        <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h2 className="font-pixel-square text-5xl leading-none tracking-tight text-neutral-950 sm:text-6xl">
              {word.name}
            </h2>
